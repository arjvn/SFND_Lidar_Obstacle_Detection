...
int main ()
{
	...
	// Create data
	std::vector<std::vector<float>> points = { {-6.2,7,1}, {-6.3,8.4,1}, {-5.2,7.1,1}, {-5.7,6.3,5}, {7.2,6.1,5}, {8.0,5.3,5}, {7.2,7.1,5}, {0.2,-7.1,3}, {1.7,-6.9,3}, {-1.2,-7.2,3}, {2.2,-8.9,3} };
